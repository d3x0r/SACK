...
macro( sack_add_executable project optional_style )
  if( __ANDROID__ )
	  ...
	  string( REPLACE "." "_" TARGET_LABEL ${project} )
	  SET_PROPERTY( TARGET ${project} APPEND PROPERTY COMPILE_DEFINITIONS "TARGETNAME=\"${project}${CMAKE_EXECUTABLE_SUFFIX}\";TARGET_LABEL=${TARGET_LABEL};TARGETNAME=\"${project}\"" )
