  ...
  if( NOT SOURCES_ROOT )
	...
	if( __ANDROID__ )
		...
		if( ${option1} STREQUAL WIN32 )
			...
			if( portable )
				set( ExtraDefinitions "${ExtraDefinitions};BUILD_PORTABLE_EXECUTABLE" )
                               	add_executable( ${targetname} ${option1} ${ARGN} ${SOURCES_ROOT}/src/deadstart/deadstart_core.c )
			else( portable )
...
macro( add_program targetname option1 )
	if( ${option1} STREQUAL WIN32 )
		add_portable_program_ex( 0 ${targetname} ${option1} ${FIRST_GCC_PROGRAM_SOURCE} ${ARGN} ${LAST_GCC_PROGRAM_SOURCE} )
	else( ${option1} STREQUAL WIN32 )
		add_portable_program_ex( 0 ${targetname} ${FIRST_GCC_PROGRAM_SOURCE} ${option1} ${ARGN} ${LAST_GCC_PROGRAM_SOURCE} )
	endif( ${option1} STREQUAL WIN32 )
