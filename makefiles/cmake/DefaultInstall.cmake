	...
	if( __ANDROID__ )
		if( ${option1} STREQUAL WIN32 )
			add_library( ${targetname}.code SHARED ${ARGN} )
                        add_library( ${targetname} SHARED ${SOURCES_ROOT}/src/deadstart/android/android_native_app_glue ${SOURCES_ROOT}/src/deadstart/android/default_android_main ${SOURCES_ROOT}/src/deadstart/android/android_util )
		...
		my_target_link_libraries( ${targetname}.code ${SACK_LIBRARIES}  )
       		set_target_properties( ${targetname}.code PROPERTIES COMPILE_DEFINITIONS "WINDOWS_SHELL;TARGET_NAME=\"${targetname}.code\";TARGET_LABEL=${TARGET_LABEL}_code" )
       		set_target_properties( ${targetname} PROPERTIES COMPILE_DEFINITIONS "WINDOWS_SHELL;TARGET_NAME=\"${targetname}\";TARGET_LABEL=${TARGET_LABEL}" )
		if( MAKING_SACK_CORE )
		...
		if( ${option1} STREQUAL WIN32 )
			...
			set_target_properties( ${targetname} PROPERTIES COMPILE_DEFINITIONS "CONSOLE_SHELL;TARGET_NAME=\"${targetname}\";TARGET_LABEL=${TARGET_LABEL}" )
		endif()
		if( MAKING_SACK_CORE )
			install_mode_dest( ${targetname} )
		else( MAKING_SACK_CORE )
