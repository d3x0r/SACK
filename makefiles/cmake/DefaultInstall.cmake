...
if( ${option1} STREQUAL WIN32 )
    set_target_properties( ${targetname} PROPERTIES COMPILE_DEFINITIONS "WINDOWS_SHELL;TARGET_NAME=\"${PROJECT_NAME}\";TARGET_LABEL=${PROJECT_NAME}" )
else()
    set_target_properties( ${targetname} PROPERTIES COMPILE_DEFINITIONS "CONSOLE_SHELL;TARGET_NAME=\"${PROJECT_NAME}\";TARGET_LABEL=${PROJECT_NAME}" )
endif()
