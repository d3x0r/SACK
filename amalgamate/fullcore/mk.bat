...
gcc -c -g -o a.o sack_ucb_full.cc
gcc -c -O3 -o a-opt.o sack_ucb_full.cc
...
gcc -g -o a.exe sack_ucb_full.cc test.cc %LIBS%
gcc -O3 -o a-opt.exe sack_ucb_full.cc test.cc %LIBS%
