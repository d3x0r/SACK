...
gcc  %MOREFLAGS% %SQLITE_OPTS% -c -g -o ac.o sack_ucb_full.c
gcc  %MOREFLAGS% %SQLITE_OPTS% -c -O3 -o ac-opt.o sack_ucb_full.c
gcc  %MOREFLAGS% %SQLITE_OPTS% -lstdc++ -c -g -o a.o sack_ucb_full.cc
gcc  %MOREFLAGS% %SQLITE_OPTS% -lstdc++ -c -O3 -o a-opt.o sack_ucb_full.cc
...
gcc  %MOREFLAGS% %SQLITE_OPTS% -g -o a.exe sack_ucb_full.cc test.cc %LIBS% -lstdc++ 
gcc  %MOREFLAGS% %SQLITE_OPTS% -lstdc++ -O3 -o a-opt.exe sack_ucb_full.cc test.cc %LIBS%

gcc %MOREFLAGS% %SQLITE_OPTS% -g -o ac.exe ac.o test.c %LIBS%
gcc %MOREFLAGS% %SQLITE_OPTS% -O3 -o ac-opt.exe ac-opt.o test.c %LIBS%

gcc %MOREFLAGS% %SQLITE_OPTS% -O3 -o ac-test2.exe ac-opt.o test2.c %LIBS%
