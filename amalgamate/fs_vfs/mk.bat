...
c:\tools\ppc.exe -c -K -once -ssio -sd -I../../include -p -oc/vfs_fs.cc -DINCLUDE_LOGGING ../../include/sack_vfs.h ../../src/filesyslib/pathops.c ../../src/utils/virtual_file_system/vfs_fs.c  ../../src/deadstart/deadstart_core.c ../../src/memlib/sharemem.c ../../src/memlib/memory_operations.c ../../src/typelib/typecode.c ../../src/typelib/text.c ../../src/typelib/sets.c ../../src/typelib/binarylist.c  %RNG% 
