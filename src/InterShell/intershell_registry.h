...
// OnCreateCommonControl("",__LINE__)(PSI_CONTROL parent,int32_t x,int32_t y,uint32_t w,uint32_t h)
...
#define OnGetControl(name) \
	DefineRegistryMethod(TASK_PREFIX,GetControl,"control",name,"get_control",PSI_CONTROL,(uintptr_t),__LINE__)
...
#define OnHideControl(name) \
	DefineRegistryMethod(TASK_PREFIX,HideControl,"control",name,"hide_control",void,(uintptr_t))

// static void OnLoadControl( "",__LINE__)( PCONFIG_HANDLER, uintptr_t psv )
...
#define OnSelectListboxItem(name,othername) \
	DefineRegistrySubMethod(TASK_PREFIX,ListSelectionChanged,"control",name,"listbox_selection_changed",othername,void,(uintptr_t,PLISTITEM),__LINE__)
#define OnDoubleSelectListboxItem(name,othername) \
	DefineRegistrySubMethod(TASK_PREFIX,ListDoubleSelectionChanged,"control",name,"listbox_double_changed",othername,void,(uintptr_t,PLISTITEM),__LINE__)
...
// static int OnChangePage("",__LINE__)( PSI_CONTROL pc_canvas )
#define OnChangePage(name) \
	  DefineRegistryMethod(TASK_PREFIX,ChangePage,"common","change page",name "_on_change_page",int,(PCanvasData),__LINE__)

// static void OnLoadCommon("",__LINE__)(PCONFIG_HANDLER pch )
...
#define OnFinishInit( name ) \
      DefineRegistryMethod(TASK_PREFIX,FinishInit,"common","finish init",name "_on_finish_init",void,(PCanvasData),__LINE__)
...
#define OnTaskLaunchComplete( name ) \
      __DefineRegistryMethod(TASK_PREFIX,TaskLaunchComplete,"common","task launch complete",name "_on_task_launch_complete",void,(void),__LINE__)
...
#define OnDropAccept(name) \
	__DefineRegistryMethod(TASK_PREFIX,DropAccept,"common","Drop Accept",name "_on_drop_accept",LOGICAL,(PSI_CONTROL,CTEXTSTR,int,int),__LINE__)
...
#define OnCopyControl(name) \
	__DefineRegistryMethod(TASK_PREFIX,CopyControl,"control",name,"copy_control",void,(uintptr_t),__LINE__)
...
#define OnPasteControl(name) \
	__DefineRegistryMethod(TASK_PREFIX,PasteControl,"control",name,"paste_control",void,(uintptr_t),__LINE__)
...
#define OnCloneControl(name) \
	__DefineRegistryMethod(TASK_PREFIX,CloneControl,"control",name,"clone_control",void,(uintptr_t,uintptr_t),__LINE__)

#define OnLoadSecurityContext( name ) \
	__DefineRegistryMethod(TASK_PREFIX,LoadSecurityContext,"common/security","Load Security",name "_load_security",void,(PCONFIG_HANDLER),__LINE__)

#define OnSaveSecurityContext( name ) \
	__DefineRegistryMethod(TASK_PREFIX,SaveSecurityContext,"common/security","Save Security",name "_save_security",void,(FILE*,uintptr_t),__LINE__)

#define OnAddSecurityContextToken( name ) \
	__DefineRegistryMethod(TASK_PREFIX,AddSecurityContextToken_,"common/security/Add Security Token",name, "add_token",void,(uintptr_t,CTEXTSTR),__LINE__)

#define OnGetSecurityContextTokens( name ) \
	__DefineRegistryMethod(TASK_PREFIX,GetSecurityContextToken_,"common/security/Get Security Tokens",name, "get_tokens",void,(uintptr_t,PLIST*),__LINE__)
...
#define TestSecurityContext( name ) \
	__DefineRegistryMethod(TASK_PREFIX,TestSecurityContext,"common/security","Test Security",name "_test_security",uintptr_t,(uintptr_t),__LINE__)
#define EndSecurityContext( name ) \
	__DefineRegistryMethod(TASK_PREFIX,TestSecurityContext,"common/security","Close Security",name "_close_security",void,(uintptr_t,uintptr_t),__LINE__)

#define OnEditSecurityContext( name ) \
	__DefineRegistryMethod(TASK_PREFIX,EditSecurityContext,"common/security","Edit Security",name,void,(uintptr_t),__LINE__)
...
#define OnThemeAdded( name ) \
	__DefineRegistryMethod(TASK_PREFIX,ThemeAdded,"common","theme/add","Theme Add:"name,void,(PCanvasData canvas, int theme_id),__LINE__)
...
#define OnThemeChanging( name ) \
	__DefineRegistryMethod(TASK_PREFIX,ThemeChanging,"common","theme/changing","Theme Changing:"name,void,(PCanvasData canvas, int theme_id),__LINE__)

/* Intended use: Receive event that theme has changed, use theme_id to update graphics if available
 static void OnThemeChanging( name )( int theme_id )
*/
#define OnThemeChanged( name ) \
	__DefineRegistryMethod(TASK_PREFIX,ThemeChanged,"common","theme/changed","Theme Change:"name,void,(PCanvasData canvas, int theme_id),__LINE__)
