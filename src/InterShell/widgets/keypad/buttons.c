...
PTHEME LoadButtonThemeByNameEx( CTEXTSTR name, int theme_id, CDATA default_color, CDATA default_text_color )
{
   ...
   snprintf( szThemeId, 12, "%d", theme_id );
	...
	// Get Mask 
	retval =  SACK_GetPrivateProfileStringEx( szTheme, "MASK", "ridge_mask.png", szBuffer, sizeof( szBuffer ), gIniFileName, TRUE );
	...
	// Get Glare
	retval =  SACK_GetPrivateProfileStringEx( szTheme, "GLARE", "glare.png", szBuffer, sizeof( szBuffer ), gIniFileName, TRUE );	
	...
	// Get Pressed
	retval =  SACK_GetPrivateProfileStringEx( szTheme, "PRESSED", "ridge_down.png", szBuffer, sizeof( szBuffer ), gIniFileName, TRUE );
	...
	// Get Normal
	retval =  SACK_GetPrivateProfileStringEx( szTheme, "NORMAL", "ridge_up.png", szBuffer, sizeof( szBuffer ), gIniFileName, TRUE );
	...
	theme->buttons.style =  SACK_GetPrivateProfileIntEx( szTheme, "Style", 1, gIniFileName, TRUE );
...
static void OnThemeAdded( "Button Widget" )( PCanvasData canvas, int theme_id )
{
	// Allocate memory for structure
...
static void OnThemeChanging( "Button Widget" )( PCanvasData canvas, int theme_id )
{

	return;
}

static void OnThemeChanged( "Button Widget" )(PCanvasData canvas,  int theme_id )
{
	INDEX idx;
