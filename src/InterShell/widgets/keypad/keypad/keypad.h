...
#define OnKeypadCancel(name) \
	  DefineRegistryMethod(TASK_PREFIX,KeypadCancel,"common","keypad cancel",name "_on_keypad_cancel",void,(PSI_CONTROL))
...
#define OnKeypadCancelType(name, typename) \
	  DefineRegistryMethod(TASK_PREFIX,KeypadTypeEnter,"common/"typename,"keypad cancel",name "_on_keypad_enter",void,(PSI_CONTROL))
