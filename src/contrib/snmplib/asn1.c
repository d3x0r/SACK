...
//static char rcsid[] =
//"$Id: asn1.c,v 1.1.1.1 2001/11/15 01:29:36 panther Exp $";
  ...
  /*    int     *objidlength; IN/OUT - number of sub-id's in objid */
{
  ...
  *datalength -= (int)asn_length + (bufp - data);
  ...
  while (length > 0 && (*objidlength)-- > 0) {
    ...
    /* this check is left in in case someone modifies something
     * that they shouldnot ...
     */
//cpg26dec2006 src\snmplib\asn1.c(702): Warning! W124: Comparison result always 0
