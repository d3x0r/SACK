...
PRIORITY_PRELOAD( VideoRegisterInterface, VIDLIB_PRELOAD_PRIORITY )
{
	...
	l.gl_image_interface = (PIMAGE_INTERFACE)GetInterface( "vulkan.image" );  // common in-memory interface...
	l._3d_image_interface = (PIMAGE_3D_INTERFACE)GetInterface( "vulkan.image.3d" );
#ifndef __ANDROID__
#ifndef UNDER_CE
#ifndef NO_TOUCH
