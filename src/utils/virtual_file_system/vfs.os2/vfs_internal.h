...
#define BLOCK_INDEX_SHIFT (BLOCK_SIZE_BITS-(sizeof(BLOCKINDEX)==16?4:sizeof(BLOCKINDEX)==8?3:sizeof(BLOCKINDEX)==4?2:sizeof(BLOCKINDEX)==2?1:0) )
...
#  ifdef VIRTUAL_OBJECT_STORE
	...
	MASKSET( seglock, BC( COUNT ), 3 );  // segment is locked into cache.
#  endif
