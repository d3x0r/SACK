...
{
	RegisterInterface( "d3d11.image", _ImageGetImageInterface, _ImageDropImageInterface );
	RegisterInterface( "d3d11.image.3d", GetImage3dInterface, DropImage3dInterface );
