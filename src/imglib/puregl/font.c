		...
		TranslateCoord( pifSrc, &xs, &ys );
		{
		   ...
		   case OrderPointsVerticalInvert:
			...
			case OrderPoints:
				...
				glTexCoord2f(x_size2, y_size); glVertex3fv(v3[v]);	// Bottom Right Of The Texture and Quad
				glTexCoord2f(x_size2, y_size2); glVertex3fv(v4[v]);	// Top Right Of The Texture and Quad
				break;
			case OrderPointsInvert:
				glTexCoord2f(x_size, y_size2); glVertex3fv(v1[v]);	// Bottom Left Of The Texture and Quad
				glTexCoord2f(x_size, y_size); glVertex3fv(v2[v]);	// Top Left Of The Texture and Quad
				glTexCoord2f(x_size2, y_size2); glVertex3fv(v3[v]);	// Bottom Right Of The Texture and Quad
				glTexCoord2f(x_size2, y_size); glVertex3fv(v4[v]);	// Top Right Of The Texture and Quad
            break;
			case OrderPointsVertical:
				glTexCoord2f(x_size, y_size2); glVertex3fv(v1[v]);	// Bottom Left Of The Texture and Quad
				glTexCoord2f(x_size, y_size); glVertex3fv(v2[v]);	// Top Left Of The Texture and Quad
            ...
            break;
			case OrderPointsVerticalInvert:
				glTexCoord2f(x_size2, y_size); glVertex3fv(v1[v]);	// Bottom Left Of The Texture and Quad
				glTexCoord2f(x_size2, y_size2); glVertex3fv(v2[v]);	// Top Left Of The Texture and Quad
				glTexCoord2f(x_size, y_size); glVertex3fv(v3[v]);	// Bottom Right Of The Texture and Quad
				glTexCoord2f(x_size, y_size2); glVertex3fv(v4[v]);	// Top Right Of The Texture and Quad
				break;
			}
			// Back Face
			glEnd();
