...
void CPROC asmInvertPixelsT0( PCDATA po, PCDATA  pi       
								  , S_32 oo, S_32 oi      
								  , _32 ws, _32 hs );   
void CPROC asmInvertPixelsT1( PCDATA po, PCDATA  pi       
								  , S_32 oo, S_32 oi      
								  , _32 ws, _32 hs );   
void CPROC asmInvertPixelsTA( PCDATA po, PCDATA  pi       
								  , S_32 oo, S_32 oi      
								  , _32 ws, _32 hs      
								  , _32 nTransparent ); 
void CPROC asmInvertPixelsTImgA( PCDATA po, PCDATA  pi    
								  , S_32 oo, S_32 oi      
								  , _32 ws, _32 hs      
								  , _32 nTransparent ); 
void CPROC asmInvertPixelsTImgAI( PCDATA po, PCDATA  pi   
								  , S_32 oo, S_32 oi      
								  , _32 ws, _32 hs      
								  , _32 nTransparent ); 

void CPROC asmInvertPixelsT0MMX( PCDATA po, PCDATA  pi       
								  , S_32 oo, S_32 oi         
								  , _32 ws, _32 hs );      
void CPROC asmInvertPixelsT1MMX( PCDATA po, PCDATA  pi       
								  , S_32 oo, S_32 oi         
								  , _32 ws, _32 hs );      
void CPROC asmInvertPixelsTAMMX( PCDATA po, PCDATA  pi       
								  , S_32 oo, S_32 oi         
								  , _32 ws, _32 hs         
								  , _32 nTransparent );    
void CPROC asmInvertPixelsTImgAMMX( PCDATA po, PCDATA  pi    
								  , S_32 oo, S_32 oi         
								  , _32 ws, _32 hs         
								  , _32 nTransparent );    
void CPROC asmInvertPixelsTImgAIMMX( PCDATA po, PCDATA  pi   
								  , S_32 oo, S_32 oi         
								  , _32 ws, _32 hs         
								  , _32 nTransparent ); 
...
BLOT_EXTERN void (CPROC*InvertPixelsT0)( PCDATA po, PCDATA  pi
								  , S_32 oo, S_32 oi
								  , _32 ws, _32 hs ) 
#ifdef IMAGE_MAIN
								  = cInvertPixelsT0
#endif
								  ;
BLOT_EXTERN void (CPROC*InvertPixelsT1)( PCDATA po, PCDATA  pi
								  , S_32 oo, S_32 oi
								  , _32 ws, _32 hs ) 
#ifdef IMAGE_MAIN
								  = cInvertPixelsT1
#endif
								  ;
BLOT_EXTERN void (CPROC*InvertPixelsTA)( PCDATA po, PCDATA  pi
								  , S_32 oo, S_32 oi
								  , _32 ws, _32 hs
								  , _32 nTransparent ) 
#ifdef IMAGE_MAIN
...
#endif
								  ;
BLOT_EXTERN void (CPROC*InvertPixelsTImgA)( PCDATA po, PCDATA  pi
								  , S_32 oo, S_32 oi
								  , _32 ws, _32 hs
								  , _32 nTransparent ) 
#ifdef IMAGE_MAIN
...
#endif
								  ;
BLOT_EXTERN void (CPROC*InvertPixelsTImgAI)( PCDATA po, PCDATA  pi
								  , S_32 oo, S_32 oi
								  , _32 ws, _32 hs
								  , _32 nTransparent ) 
#ifdef IMAGE_MAIN
...
BLOT_EXTERN void (CPROC*BlotInvertScaledT0)( SCALED_BLOT_WORK_PARAMS )
#ifdef IMAGE_MAIN
								  = cBlotInvertScaledT0
#endif
				          
				          ;   
BLOT_EXTERN void (CPROC*BlotInvertScaledT1)( SCALED_BLOT_WORK_PARAMS )
#ifdef IMAGE_MAIN
								  = cBlotInvertScaledT1
#endif
				             ;   
BLOT_EXTERN void (CPROC*BlotInvertScaledTA)( SCALED_BLOT_WORK_PARAMS
								  , _32 nTransparent )
#ifdef IMAGE_MAIN
								  = cBlotInvertScaledTA
#endif
								  ; 
BLOT_EXTERN void (CPROC*BlotInvertScaledTImgA)( SCALED_BLOT_WORK_PARAMS
								  , _32 nTransparent )
#ifdef IMAGE_MAIN
								  = cBlotInvertScaledTImgA
#endif
								  ; 
BLOT_EXTERN void (CPROC*BlotInvertScaledTImgAI)( SCALED_BLOT_WORK_PARAMS
								  , _32 nTransparent )
#ifdef IMAGE_MAIN
								  = cBlotInvertScaledTImgAI
#endif
								  ; 
