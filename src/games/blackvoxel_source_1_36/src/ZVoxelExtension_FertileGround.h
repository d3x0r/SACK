...
#ifndef Z_ZVOXELEXTENSION_FERTILE_GROUND_H
#define Z_ZVOXELEXTENSION_FERTILE_GROUND_H
...
class ZVoxelExtension_FertileGround : public ZVoxelExtension
{
  public:
    double time_since_spawn;

  ZVoxelExtension_FertileGround()
  {
    ExtensionType = Extension_FertileGround;
  ...
  {
    ZVoxelExtension_FertileGround * NewCopy;
    NewCopy = new ZVoxelExtension_FertileGround(*this);
    return(NewCopy);
  }
