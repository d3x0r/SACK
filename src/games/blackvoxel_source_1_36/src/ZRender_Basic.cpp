  ...
  // Preparation and first rendering pass
    ...
    for (ULong Entry=0; Entry<SectorsToProcess; Entry++ )
    {
      ...
      // for (z = Start_z; z <= End_z ; z++)
          ...
          SectorVisible = false;
          Cv2.x = (0 * ZVOXELBLOCSIZE_X * 256.0); Cv2.y = (0 * ZVOXELBLOCSIZE_Y * 256.0); Cv2.z = (0 * ZVOXELBLOCSIZE_Z * 256.0); Cv2 += Cv ; SectorVisible |= Is_PointVisible(Camera->orientation, &Cv2);
          Cv2.x = (1 * ZVOXELBLOCSIZE_X * 256.0); Cv2.y = (0 * ZVOXELBLOCSIZE_Y * 256.0); Cv2.z = (0 * ZVOXELBLOCSIZE_Z * 256.0); Cv2 += Cv ; SectorVisible |= Is_PointVisible(Camera->orientation, &Cv2);
          Cv2.x = (1 * ZVOXELBLOCSIZE_X * 256.0); Cv2.y = (0 * ZVOXELBLOCSIZE_Y * 256.0); Cv2.z = (1 * ZVOXELBLOCSIZE_Z * 256.0); Cv2 += Cv ; SectorVisible |= Is_PointVisible(Camera->orientation, &Cv2);
          Cv2.x = (0 * ZVOXELBLOCSIZE_X * 256.0); Cv2.y = (0 * ZVOXELBLOCSIZE_Y * 256.0); Cv2.z = (1 * ZVOXELBLOCSIZE_Z * 256.0); Cv2 += Cv ; SectorVisible |= Is_PointVisible(Camera->orientation, &Cv2);
          Cv2.x = (0 * ZVOXELBLOCSIZE_X * 256.0); Cv2.y = (1 * ZVOXELBLOCSIZE_Y * 256.0); Cv2.z = (0 * ZVOXELBLOCSIZE_Z * 256.0); Cv2 += Cv ; SectorVisible |= Is_PointVisible(Camera->orientation, &Cv2);
          Cv2.x = (1 * ZVOXELBLOCSIZE_X * 256.0); Cv2.y = (1 * ZVOXELBLOCSIZE_Y * 256.0); Cv2.z = (0 * ZVOXELBLOCSIZE_Z * 256.0); Cv2 += Cv ; SectorVisible |= Is_PointVisible(Camera->orientation, &Cv2);
          Cv2.x = (1 * ZVOXELBLOCSIZE_X * 256.0); Cv2.y = (1 * ZVOXELBLOCSIZE_Y * 256.0); Cv2.z = (1 * ZVOXELBLOCSIZE_Z * 256.0); Cv2 += Cv ; SectorVisible |= Is_PointVisible(Camera->orientation, &Cv2);
          Cv2.x = (0 * ZVOXELBLOCSIZE_X * 256.0); Cv2.y = (1 * ZVOXELBLOCSIZE_Y * 256.0); Cv2.z = (1 * ZVOXELBLOCSIZE_Z * 256.0); Cv2 += Cv ; SectorVisible |= Is_PointVisible(Camera->orientation, &Cv2);
