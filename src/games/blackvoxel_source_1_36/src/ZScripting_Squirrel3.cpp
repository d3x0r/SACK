...
SQInteger function_GetInfo(HSQUIRRELVM v)
{
  ...
  switch (DataType)
  {
    ...
    case 4: sq_pushinteger(v, (SQInteger)  (Long)(((ELong) S->GameEnv->PhysicEngine->GetSelectedActor()->ViewDirection.x() ) >> 8) );  break;
    case 5: sq_pushinteger(v, (SQInteger)  (Long)(((ELong) S->GameEnv->PhysicEngine->GetSelectedActor()->ViewDirection.y() ) >> 8) );  break;
    case 6: sq_pushinteger(v, (SQInteger)  (Long)(((ELong) S->GameEnv->PhysicEngine->GetSelectedActor()->ViewDirection.z() ) >> 8) );  break;
    ...
    case 14: {ZActor * Actor = S->GameEnv->PhysicEngine->GetSelectedActor(); sq_pushinteger(v, (SQInteger) (Long)(((ELong) (Actor->ViewDirection.x() + Actor->EyesPosition.x) ) >> 8) ); } break;
    case 15: {ZActor * Actor = S->GameEnv->PhysicEngine->GetSelectedActor(); sq_pushinteger(v, (SQInteger) (Long)(((ELong) (Actor->ViewDirection.y() + Actor->EyesPosition.y) ) >> 8) ); } break;
    case 16: {ZActor * Actor = S->GameEnv->PhysicEngine->GetSelectedActor(); sq_pushinteger(v, (SQInteger) (Long)(((ELong) (Actor->ViewDirection.z() + Actor->EyesPosition.z) ) >> 8) ); } break;
