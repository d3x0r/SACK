...
TEXTCHAR *board_layer = "CREATE TABLE `board_layer` ("
...
//#
TEXTCHAR *board_layer_link = "CREATE TABLE `board_layer_link` ("
"  `board_layer_id` int(11) NOT NULL default '0',"
"  `board_info_id` int(11) NOT NULL default '0',"
"  PRIMARY KEY  (`board_layer_id`)"
TABLE_TYPE; 
...
//#
TEXTCHAR *board_layer_neuron = "CREATE TABLE `board_layer_neuron` ("
...
//#
TEXTCHAR *board_layer_path = "CREATE TABLE `board_layer_path` ("
...
//#
TEXTCHAR *board_layer_synapse = "CREATE TABLE `board_layer_synapse` ("
"  `board_layer_id` int(11) NOT NULL default '0',"
...
//#Table: 'brain_info'
//#
TEXTCHAR *brain_info = "CREATE TABLE `brain_info` ("
...
//#Table: 'brain_neuron'
//#
TEXTCHAR *brain_neuron = "CREATE TABLE `brain_neuron` ("
...
//#Table: 'brain_synapse'
//#
TEXTCHAR *brain_synapse = "CREATE TABLE `brain_synapse` ("
...
TEXTCHAR *brain_connectors = "CREATE TABLE `brain_connectors` ("
