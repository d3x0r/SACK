...
void DestroyLinePSet( PLINESEGSET pps );
...
PFACET AddPlane( PFACETSET pPlaneSet, PCVECTOR origin, PCVECTOR norm, char d );
...
bool AbovePlane( PVECTOR n, PVECTOR o, PVECTOR p );
bool PointWithin( PCVECTOR p, PLINESEGPSET pls ); 
...
inline bool AbovePlane( PVECTOR n, PVECTOR o, PVECTOR p )
{
