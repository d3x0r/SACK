   ...
   else if( left && _left ) // probably dont want to do this if !left && !_left
   {
      if( pe->bDragOrigin )
      {
         ...
         if( pe->ptMouseDel[0] || pe->ptMouseDel[1] )
         {
			...
			Invert( vo );
            GetRealPoint( GetDisplayImage( pe->hVideo ), (PVECTOR)vo, pe->ptMouse );
      ...
      else if( pe->bDragNormal )
      {
         ...
         if( pe->ptMouseDel[0] || pe->ptMouseDel[1] )
         {
            ...
            Invert( vn );
            GetRealPoint( GetDisplayImage( pe->hVideo ), (PVECTOR)vn, pe->ptMouse );
      ...
      else if( pe->bDragWorld )
      {
         ...
         if( pe->ptMouseDel[0] || pe->ptMouseDel[1] )
         {
            ...
            GetRealPoint( GetDisplayImage( pe->hVideo ), (PVECTOR)v1, pe->ptMouse );
            GetRealPoint( GetDisplayImage( pe->hVideo ), (PVECTOR)v2, pe->ptMouseDel );
            sub( v1, v2, v1 );
            v1[vForward] = 0; 
