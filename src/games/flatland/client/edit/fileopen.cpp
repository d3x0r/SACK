...
#define BOOL int
#endif
LOGICAL SelectExistingFile( PSI_CONTROL parent, char * szFile, int buflen, char * filter )
{
#ifdef COMPAT_MODE
...
//------------------------------------------
LOGICAL SelectNewFile( PSI_CONTROL parent, char * szFile, int buflen, char * filter )
{
#ifdef COMPAT_MODE
