...
enum { // options ... not really routines
...
option_entry options[]={
  {DEFTEXT(WIDE("ANCHOR")) ,0,6  ,DEFTEXT(WIDE("Trigger must start first on line")),(OptionHandler)ANCHOR}
 ,{DEFTEXT(WIDE("FREE"))   ,0,4  ,DEFTEXT(WIDE("Trigger may occur at any time")),(OptionHandler)FREE}
 ,{DEFTEXT(WIDE("ONCE"))   ,0,4  ,DEFTEXT(WIDE("Once trigger occurs, it auto disables")),(OptionHandler)ONCE}
 ,{DEFTEXT(WIDE("ONCEOFF")),0,7  ,DEFTEXT(WIDE("Disable a trigger once, it auto enables")),(OptionHandler)ONCEOFF}
 ,{DEFTEXT(WIDE("MULTI"))  ,0,5  ,DEFTEXT(WIDE("Enables and clears ONCE option")),(OptionHandler)MULTI}
 ,{DEFTEXT(WIDE("CONSUME")),0,7  ,DEFTEXT(WIDE("If input line trips trigger, delete data")),(OptionHandler)CONSUME}
 ,{DEFTEXT(WIDE("PASS"))   ,0,4  ,DEFTEXT(WIDE("Trigger does not delete input data")),(OptionHandler)PASS}
 ,{DEFTEXT(WIDE("ENABLE")) ,0,6  ,DEFTEXT(WIDE("Enable a trigger")),(OptionHandler)ENABLE}
 ,{DEFTEXT(WIDE("DISABLE")),0,7  ,DEFTEXT(WIDE("Disable a trigger")),(OptionHandler)DISABLE}
 ,{DEFTEXT(WIDE("EXACT"))  ,0,5  ,DEFTEXT(WIDE("Compare template case sensitive")),(OptionHandler)EXACT}
 ,{DEFTEXT(WIDE("SIMILAR")),0,7  ,DEFTEXT(WIDE("Compare template without case")),(OptionHandler)SIMILAR}
 ,{DEFTEXT(WIDE("RUN"))    ,0,3  ,DEFTEXT(WIDE("Allow trigger to run and relay data")),(OptionHandler)RUN}
 ,{DEFTEXT(WIDE("LOCK"))   ,0,4  ,DEFTEXT(WIDE("Stop relaying data while trigger runs")),(OptionHandler)LOCK}
 ,{DEFTEXT(WIDE("HELP"))   ,0,4  ,DEFTEXT(WIDE("Show this list")),(OptionHandler)HELPVAL}
};
...
PUBLIC( TEXTCHAR *, RegisterRoutines )( void )
{
   ...
   RegisterOptions( WIDE("TRIGGER"), options, nOptions );
   myTypeID = RegisterDevice( WIDE("trigger"), WIDE("Fictional Trigger device layer"), OpenTriggerSet );
