...
public:
	...
	virtual PEICE_PROC( PTRSZVAL, Create )( PTRSZVAL psv_userdata, PLAYER_DATA layer );
	...
	virtual PEICE_PROC( int, OnTap )( PTRSZVAL psvInstance, S_32 x, S_32 y );
	virtual PEICE_PROC( int, OnBeginDrag )( PTRSZVAL psvInstance, S_32 x, S_32 y );
	...
	//virtual void DrawExtra( PTRSZVAL psv, Image surface, S_32 x, S_32 y, _32 w, _32 h ) = 0;
