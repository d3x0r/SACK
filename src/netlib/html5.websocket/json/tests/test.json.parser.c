...
int main( void )
{
	...
	json_add_object_member_array( object1, WIDE("v1"), offsetof( struct message1, v), JSON_Element_Integer_64, 0, 3, JSON_NO_OFFSET );
	...
	object1_sub1 = json_add_object_member( object1, WIDE("sub2"), offsetof( struct message1, sub2), JSON_Element_ObjectPointer, sizeof( struct part1 ) );
	json_add_object_member( object1_sub2, WIDE("x"), offsetof( struct part1, x), JSON_Element_Float, 0 );
