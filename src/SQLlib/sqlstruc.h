...
#define EXTRAREF
#endif
#define sqlite3_result_text          (EXTRAREF sqlite_iface->sqlite3_result_text)
#define sqlite3_user_data            (EXTRAREF sqlite_iface->sqlite3_user_data)
#define sqlite3_last_insert_rowid    (EXTRAREF sqlite_iface->sqlite3_last_insert_rowid)
#define sqlite3_create_function      (EXTRAREF sqlite_iface->sqlite3_create_function)
#define sqlite3_get_autocommit       (EXTRAREF sqlite_iface->sqlite3_get_autocommit)
#define sqlite3_open(a,b)            (sqlite_iface)?(EXTRAREF (sqlite_iface)->sqlite3_open)(a,b):SQLITE_ERROR
#define sqlite3_errmsg(db)           (sqlite_iface)?(EXTRAREF (sqlite_iface)->sqlite3_errmsg)(db):"No Sqlite3 Interface"
#define sqlite3_finalize             (EXTRAREF sqlite_iface->sqlite3_finalize)
#define sqlite3_close                (EXTRAREF sqlite_iface->sqlite3_close)
#define sqlite3_prepare_v2           (EXTRAREF sqlite_iface->sqlite3_prepare_v2)
#define sqlite3_step                 (EXTRAREF sqlite_iface->sqlite3_step)
#define sqlite3_column_name          (EXTRAREF sqlite_iface->sqlite3_column_name)
#define sqlite3_column_text          (EXTRAREF sqlite_iface->sqlite3_column_text)
#define sqlite3_column_bytes         (EXTRAREF sqlite_iface->sqlite3_column_bytes)
#define sqlite3_column_type          (EXTRAREF sqlite_iface->sqlite3_column_type)
#define sqlite3_column_count         (EXTRAREF sqlite_iface->sqlite3_column_count)
#define sqlite3_config            (EXTRAREF sqlite_iface->sqlite3_config)
#define sqlite3_db_config         (EXTRAREF sqlite_iface->sqlite3_db_config)
#endif
