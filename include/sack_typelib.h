...
/* This is a iterator which can be used to check each member in
   ...
   the loop.
                                                                                         */
#define LIST_FORALL( l, i, t, v )  if(((i)=0),((v)=(t)(uintptr_t)NULL),(l))            \
                                            for( ; ((i) < ((l)->Cnt))? \
                                        (((v)=(t)(uintptr_t)((l)->pNode[i])),1):(((v)=(t)(uintptr_t)NULL),0); (i)++ )  if( v )
...
typedef struct user_input_buffer_tag {
   ...
   /* A exchange-lock variable for controlling access to the
	...
	int   storeCR; // flag for whether we are inserting or overwriting
