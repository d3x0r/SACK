...
#define OnInit3d(name) \
	DefineRegistryMethod(WIDE("sack/render/puregl"),Init3d,WIDE("init3d"),name,WIDE("ExtraInit3d"),uintptr_t,( EXTRA_INIT_PARAM PMatrix projection, PTRANSFORM camera, RCOORD *identity_depth, RCOORD *aspect ),__LINE__)
...
#define OnClose3d(name) \
	DefineRegistryMethod(WIDE("sack/render/puregl"),Close3d,WIDE("draw3d"),name,WIDE("ExtraClose3d"),void,(uintptr_t psvInit),__LINE__)
...
#define OnResume3d(name) \
	DefineRegistryMethod(WIDE("sack/render/puregl"),Resume3d,WIDE("draw3d"),name,WIDE("Resume3d"),void,(void),__LINE__)
...
#define OnUpdate3d(name) \
	DefineRegistryMethod(WIDE("sack/render/puregl"),Update3d,WIDE("draw3d"),name,WIDE("Update3d"),LOGICAL,(PTRANSFORM origin ),__LINE__)
...
#define OnFirstDraw3d(name) \
	DefineRegistryMethod(WIDE("sack/render/puregl"),FirstDraw3d,WIDE("draw3d"),name,WIDE("FirstDraw3d"),void,(uintptr_t psvInit ),__LINE__)
...
#define OnBeginDraw3d(name) \
	DefineRegistryMethod(WIDE("sack/render/puregl"),BeginDraw3d,WIDE("draw3d"),name,WIDE("ExtraBeginDraw3d"),void,(uintptr_t psvUser,PTRANSFORM camera),__LINE__)
...
#define OnDraw3d(name) \
	DefineRegistryMethod(WIDE("sack/render/puregl"),Draw3d,WIDE("draw3d"),name,WIDE("ExtraDraw3d"),void,(uintptr_t psvUser),__LINE__)
...
#define OnMouse3d(name) \
	DefineRegistryMethod(WIDE("sack/render/puregl"),Mouse3d,WIDE("draw3d"),name,WIDE("ExtraMouse3d"),LOGICAL,(uintptr_t psvUser, PRAY mouse_ray, int32_t x, int32_t y, uint32_t b),__LINE__)
...
#define OnKey3d(name) \
	DefineRegistryMethod(WIDE("sack/render/puregl"),Key3d,WIDE("draw3d"),name,WIDE("ExtraKey3d"),LOGICAL,(uintptr_t psvUser, uint32_t key),__LINE__)
