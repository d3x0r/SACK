...
#define OnHideCommon(name) \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,HideCommon,"control",name "/hide_control",PASTE(name,"hide_control"),void,(PSI_CONTROL),__LINE__)
...
#define OnRevealCommon(name) \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,RevealCommon,"control",name "/reveal_control","reveal_control",void,(PSI_CONTROL),__LINE__)
...
#define OnCreateCommon(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnCreateCommon,"control",name "/rtti","init",int,(PSI_CONTROL), __LINE__)
...
#define OnDrawCommon(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnDrawCommon,"control",name "/rtti","draw",int,(PSI_CONTROL), __LINE__)
...
#define OnDrawCaption(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnDrawCaption,"control",name "/rtti","draw_caption",void,(PSI_CONTROL, Image), __LINE__)
...
#define OnDrawCommonDecorations(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnDrawCommonDecorations,"control",name "/rtti","decoration_draw",void,(PSI_CONTROL,PSI_CONTROL), __LINE__)
...
#define OnMouseCommon(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnMouseCommon,"control",name "/rtti","mouse",int,(PSI_CONTROL,int32_t,int32_t,uint32_t), __LINE__)
...
#define OnKeyCommon(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnKeyCommon,"control",name "/rtti","key",int,(PSI_CONTROL,uint32_t), __LINE__)
...
#define OnMoveCommon(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnMoveCommon,"control",name "/rtti","position_changing",void,(PSI_CONTROL,LOGICAL), __LINE__)
...
#define OnSizeCommon(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnSizeCommon,"control",name "/rtti","resize",void,(PSI_CONTROL,LOGICAL), __LINE__)
/* User event that is triggered when the size of a control
   changes.
   Example
   The logical parameter passed is TRUE when sizing starts, and
...
#define OnScaleCommon(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnScaleCommon,"control",name "/rtti","rescale",void,(PSI_CONTROL), __LINE__)
...
#define OnMotionCommon(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnMotionCommon,"control",name "/rtti","some_parents_position_changing",void,(PSI_CONTROL,LOGICAL), __LINE__)
...
#define OnDestroyCommon(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnDestroyCommon,"control",name "/rtti","destroy",void,(PSI_CONTROL), __LINE__)
...
#define OnPropertyEdit(name) \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,PropertyEditControl,"control",name "/rtti","get_property_page",PSI_CONTROL,(PSI_CONTROL),__LINE__)
...
#define OnCommonFocus(name) \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,FocusChanged,"control",name "/rtti","focus_changed",int,(PSI_CONTROL,LOGICAL),__LINE__)
...
#define OnEditFrame(name) \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,FrameEditControl,"control",name "/rtti","begin_frame_edit",void,(PSI_CONTROL),__LINE__)
...
#define OnEditFrameDone(name) \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnEditFrameDone,"control",name "/rtti","end_frame_edit",void,(PSI_CONTROL),__LINE__)
// somet
...
#define OnPropertyEditOkay(name) \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnPropertyEditOkay,"control",name "/rtti","read_property_page",void,(PSI_CONTROL,PSI_CONTROL),__LINE__)
...
#define OnPropertyEditCancel(name) \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,PropertyEditCancelControl,"control",name "/rtti","abort_property_page",void,(PSI_CONTROL,PSI_CONTROL),__LINE__)
...
#define OnPropertyEditDone( name )  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,PropertyEditDoneControl,"control",name "/rtti","done_property_page",void,(PSI_CONTROL),__LINE__)

#define OnChangeCaption( name )  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,OnChangeCaption,"control",name "/rtti","caption_changed",void,(PSI_CONTROL), __LINE__)
...
#define OnTouchCommon(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnTouchCommon,"control",name "/rtti","touch_event",int,(PSI_CONTROL,PINPUT_POINT,int), __LINE__)
...
#define OnDrawCustomBorder(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnDrawCustomBorder,"control",name "/rtti","border_draw",void,(PSI_CONTROL,Image), __LINE__)
...
#define OnMeasureCustomBorder(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnMeasureCustomBorder,"control",name "/rtti","border_measure",void,(PSI_CONTROL,int*,int*,int*,int*), __LINE__)


// static LOGICAL OnDropAccept("")(PSI_CONTROL pc_canvas,CTEXTSTR filepath,int x,int y)
#define OnControlDropAccept(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnControlDropAccept,"control",name "/rtti","drop_accept",LOGICAL,(PSI_CONTROL,CTEXTSTR,int32_t,int32_t), __LINE__)
...
#define OnControlRollover(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnControlRollover,"control",name "/rtti","rollover",void,(PSI_CONTROL,LOGICAL), __LINE__)
...
#define OnControlFontChanged(name)  \
	DefineRegistryMethod(PSI_ROOT_REGISTRY,_OnControlFontChange,"control",name "/rtti","font_change",void,(PSI_CONTROL), __LINE__)
