typedef struct _VEN_TABLE
{
	unsigned short	VenId ;
	char *	VenShort ;
	char *	VenFull ;
}  VEN_TABLE, *PVEN_TABLE ;
...
VEN_TABLE	VenTable [] =
{
	...
	{ 0x1106, "Keitan", "Keitan Technologies, Inc." } ,
...
#define	VEN_TABLE_LEN	(sizeof(VenTable)/sizeof(VEN_TABLE))
...
DEV_TABLE	DevTable [] =
{
	...
	{ 0x3D3D, 0x3D07/*104c*/, "same as above?  I have no idea", "?" } ,
	...
	{ 0x8086, 0x027A/*E*/, "82945GM", "Mobile Intel(R) 945 Express Chipset Family" } ,
	{ 0x8086, 0x0283/*E*/, "AA01211025", "Intel(R) ICH8 Family SMBus Controller" } ,
	...
	{ 0x8086, 0x1c4a, "0780", "pci simple communications controller" } ,
	...
	{ 0x8086, 0x27d8/*xzx*/, "PCI\\VEN_8086&DEV_27D8&SUBSYS_75291462&REV_01\\3&115", "Microsoft UAA Bus HD Audio" } ,
	...
	{ 0x8086, 0x2E14, "PCI\\VEN_8086&DEV_1c22", "SM BUS CONTROLLER" } ,
	...
	{ 0x8086, 0x2E24, "PCI\\VEN_8086&DEV_2E24&SUBSYS_00248086 ", "Intel Management Engine Interface" } ,
	...
	{ 0x8086, 0x8086/*&DEV_3B64*/, "SUBSYS_11171043", "REV_06" } ,
	...
	{ 0x8086, 0xC50, "fd", "sdf" } ,
	{ 0x8086, 0x0 /*PCI\VEN_8086&DEV_3*/, "11583659", "PCI\\VEN_8086&DEV_3B64&SUBSYS_3B648086&REV_06\\3&11583659&0&B0 " } ,
	...
	{ 0x8086, 0x_1E3A, "not sure?", "i5 2500k?" } ,
	...
	{ 0x15D7, 0x0000 /*RS56*/, "hcf cx11252-41z", "hcf 56" } ,
	{ 0x15D8, 0x9001, "", "" } ,
	...
	{ 0x14F1, 0x5045/*1*/, "14f12f30", "Conextant High Definition Audio-Venice 5051" } ,
	{ 0x14F1, 0x5045/*2	*/, "14e4", "Conextant High Definition SmartAudio 221" } ,
	{ 0x14F1, 0x5045/*2*/, "PCI\\VEN_14F1&DEV_5047", "Conextant High Definition Audio-Venice 5051" } ,
	...
	{ 0x8080, 0x1040, "VIA 82C259 rev 0", "PCI\\VEN_8080&DEV_0016&SUBSYS_813D100D&REV_01\\4&23C0b1C5&0&00F0" } ,
	{ 0x0c45, 0x0C45, "USB\\VID_0C45&PID_602C\\6&E653CF0B&0&2", "USB2.0 webcam" } ,
	...
	{ 0x0c45, 0x6130, "USB\\VID_0000&PID_0000\\&5B68CAE&0&5", "USB CAMERA" } ,
	...
	{ 0x0c45, 0x6270, "USB\\VID_0C45&PID_6422", "USB Microscopr" } ,
	...
	{ 0x7d1, 0x3C07, "D-Link Wireless G DWA-110 USB Adapter", "USB\\VID_07D1&PID_3C07" } ,
	...
	{ 0x10EC, 0x0260, "Realtek ALC260 High Definition Audio", "VEN_10EC&DEV_0260" } ,
	...
	{ 0x10EC, 0x8168, "RTL8168", "PCIe Gigabit Ethernet Family Controller" } ,
	...
	{ 0x168C, 0x0013, "AR5235", "PCI\\VEN_168C&DEV_0023&SUBSYS_3A621186&REV_01" } ,
	...
	{ 0x168C, 0x001c, "nvidia geforce gt540m", "PCI\\VEN_10DE&DEV_0531&SUBSYS_30CF103C&REV_A2\\3&2411E6FE&0&90" } ,
	...
	{ 0x168C, 0x002A, "2", "Atheros AR5B92 " } ,
	...
	{ 0x168C, 0x168C, "0x002b", "PCI\\VEN_168C&DEV_002B&SUBSYS_30AF185F " } ,
	...
	{ 0x1002, 0x1802, "LXPAY0Y001926158A92000        ", "AMD Athlon(tm) X2 Dual-Core QL-62" } ,
	...
	{ 0x1407, 0x520, "s", "s" } ,
	{ 0x1407, 0x8000, "PCI\\VEN_1407&DEV_8000", "Lava Parallel" } ,
	...
	{ 0x10CA, 0x9876, "ROOT\\HAJOCAP\\0001", "The drivers for this device are not installed." } ,
	...
	{ 0x1106, 0x3059, "VT8235", "VIA AC'97 Enhanced Audio Controller " } ,
	{ 0x1106, 0x3065, "VT6102  / VT6103", "VIA Rhine II Fast Ethernet Adapter " } ,
	...
	{ 0x1106, 0x3108, "8380", "VIA/S3G UniChrome Pro IGP (Integrated Video Adapter)" } ,
	...
	{ 0x14E4, 0x4727, "DELL DW1501 Half-Mini WLAN", "DELL DW1501 Half-Mini WLAN" } ,
	...
	{ 0x1179, 0x1179, "0x8136", "pci &#1091;&#1089;&#1090;&#1088;&#1086;&#1081;&#1089;&#1090;&#1074;&#1072; &#1089;&#1074;&#1103;&#10" } ,
	{ 0x1179, 0x0404, "", "" } ,
	...
	{ 0x1179, 0x0805, "ACPI\\TOS6205\\2&DABA3FF&1", "ACPI\\TOS6205\\2&DABA3FF&1" } ,
	...
	{ 0x1179, 0x9876, "ACPI\\TOS1901\\2&DABA3FF&1", "SD Card Controller" } ,
...
// Use this value for loop control during searching:
#define	DEV_TABLE_LEN	(sizeof(DevTable)/sizeof(DEV_TABLE))

typedef struct _CLASS_CODE_TABLE
{
	...
	char *		SubDesc ;
	char *		ProgDesc ;
}  CLASS_CODE_TABLE, *PCLASS_CODE_TABLE ;

CLASS_CODE_TABLE ClassCodeTable [] =
{
...
// Use this value for loop control during searching:
#define	CLASS_CODE_TABLE_LEN	(sizeof(ClassCodeTable)/sizeof(CLASS_CODE_TABLE))
...
// Use this value for loop control during searching:
#define	COMMAND_FLAGS_LEN	(sizeof(CommandFlags)/sizeof(char *))
...
// Use this value for loop control during searching:
#define	STATUS_FLAGS_LEN	(sizeof(StatusFlags)/sizeof(char *))
...
// Use this value for loop control during searching:
#define	DEV_SEL_FLAGS_LEN	(sizeof(DevSelFlags)/sizeof(char *))
